...
<template>
  <div>
    ...
    <FormKit type="form" id="student-registration" submit-label="Register" @submit="submitHandler"
      @click="cleanSuccessSubmitMessage" :actions="false" v-model="formData"
      incomplete-message="Por favor completa todos los campos" :classes="{ form: '$reset mt-4' }">
  ...
  non_answer: 'Prefiero no decirlo'
        ...
        <FormKit type="checkbox" name="courses" label="Cursos" decorator-icon="check" validation="required|min:2"
          :validation-messages="{
